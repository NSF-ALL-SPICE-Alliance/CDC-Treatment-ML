...
relevant_data <- teds_d_select_years_completed_outcomes_aggregated %>% 
  select(freq1, freq1_d, frequency_of_use_change_specific, frequency_of_use_change_aggregate,
                              ...
                              freq_atnd_self_help, freq_atnd_self_help_d, self_help_change_aggregate, self_help_change_specific, services, services_d, los, stfips)
```
...
```{r}
ggplot(los_by_state, aes(x = los, y = reorder(state_name, median), fill = median)) +
